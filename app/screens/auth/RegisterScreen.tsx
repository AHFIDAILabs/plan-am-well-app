...
// 🛠️ REQUIRED: Import the Picker component for the dropdown
...
export default function RegisterScreen({ navigation }: Props) {
  ...
  const [form, setForm] = useState<any>({
    ...
    lastName: "",
    phone: "",
    // 🛠️ FIX 1: Set default gender to one of the correct Enum values.
    gender: "Male",
    dob: "",
    bloodGroup: "",
    specialization: "",
  ...
  const handleRegister = async () => {
    ...
    // 🛠️ VALIDATION: Ensure gender is selected before registering
